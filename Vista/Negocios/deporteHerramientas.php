...
<html lang="en">
    ...
    <head>
        ...
        <script src="../../Controlador/CtlDeporte.js"></script>
        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        <label>ID</label>
                        <input type="text" name="" id="idDeporteA" class="form-control input-sm" disabled="true">
                        <label>Nombre</label>
                        <input type="text" name="" id="nombreDeporteA" class="form-control input-sm">
        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        <label>Nombre</label>
                        <input type="text" id="nombreDeporte" class="form-control input-sm" required="true">
                    </form>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" id="cancelar" data-dismiss="modal">Cancelar</button>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                $('#actualizadatos').click(function () {
                    nombre = $('#nombreDeporteA').val();
                    id = $('#idDeporteA').val();
                    if (nombre === "") {
                        alertify.error("Por favor llene todos los campos");
                    } else {
                        lista = [id,nombre,"deporte", "2"];
                        agregardatosDeporte(lista);
                    }
                });
